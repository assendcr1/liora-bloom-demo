    ...
    <>
      ...
      <section className="bg-stone-900 py-32 text-white">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-20">
          <div>
            <h3 className="text-[11px] font-bold uppercase tracking-widest text-#c5a059 mb-6">Our Mission</h3>
          ...
          <div>
            <h3 className="text-[11px] font-bold uppercase tracking-widest text-#c5a059 mb-6">Our Vision</h3>
            <p className="text-3xl font-light font-serif leading-snug">
      ...
      <section className="px-6 md:px-12 py-36 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-16 text-center">
          <div>
            <Sun className="mx-auto mb-6 text-#c5a059" size={36} strokeWidth={1.5} />
          ...
          <div>
            <HandHeart className="mx-auto mb-6 text-#c5a059" size={36} strokeWidth={1.5} />
          ...
          <div>
            <Sparkles className="mx-auto mb-6 text-#c5a059" size={36} strokeWidth={1.5} />
          ...
          <div>
            <ShieldCheck className="mx-auto mb-6 text-#c5a059" size={36} strokeWidth={1.5} />
